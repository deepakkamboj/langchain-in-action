...
flowchart TD
    ...
    %% Color styling
    classDef platform fill:#4a90e2,stroke:#357abd,stroke-width:3px,color:#fff
    classDef framework fill:#7b68ee,stroke:#6a5acd,stroke-width:2px,color:#fff
    classDef langgraph fill:#ff6b6b,stroke:#e55555,stroke-width:2px,color:#fff
    classDef langsmith fill:#4ecdc4,stroke:#45b7aa,stroke-width:2px,color:#fff
    classDef features fill:#ffd93d,stroke:#e6c200,stroke-width:1px,color:#333
    classDef usecases fill:#95e1d3,stroke:#7bc4b8,stroke-width:2px,color:#333

    class A platform
    class B framework
    class C langgraph
    class D langsmith
    class E,F,G,H,I,J,K,L,M features
    class N,O,P usecases
```
...
**WARNING**: LangChain agents are built on top of LangGraph, giving you access to all these advanced features even when using the simpler LangChain interface.
